            ...
            <form method="post" action="{{route('admin.images.slider-banners.update')}}" enctype="multipart/form-data">
                ...
                <div class="row col-5 mb-4 ">
                    ...
                    <input type="text" id="image_link_check_banner1" style="display:none" name="image_link_check_banner1"
                        value="{{$sliders->firstWhere('id', 2)->image_link}}">
                    <img id="previewImage_banner1" src="{{asset('/img/slider-banner/' . $sliders->firstWhere('id', 2)->image_link) }}" class="mt-2 img-thumbnail"
                        alt="Preview">
                    ...
                    <input type="text" id="image_link_check_banner2" style="display:none" name="image_link_check_banner2"
                        value="{{$sliders->firstWhere('id', 3)->image_link}}">
                    <img id="previewImage_banner2" src="{{asset('/img/slider-banner/' . $sliders->firstWhere('id', 3)->image_link) }}" class="mt-2 img-thumbnail"
                        alt="Preview">
                    ...
                    <input type="text" id="image_link_check_banner3" style="display:none" name="image_link_check_banner3"
                        value="{{$sliders->firstWhere('id', 4)->image_link}}">
                    <img id="previewImage_banner3" src="{{asset('/img/slider-banner/' . $sliders->firstWhere('id', 4)->image_link) }}" class="mt-2 img-thumbnail"
                        alt="Preview">
