                ...
                <form method="post" action="{{ route('admin.products.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                            <select name="catalog_id" class="shadow form-select">
                                ...
                                <option value="{{$catalog->id}}"
                                    {{old('catalog_id') == $catalog->id ? 'selected' : '' }}>{{$catalog->catalog_name}}
                                </option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select name="feature_id" class="shadow form-select">
                                ...
                                <option value="{{$feature->id}}"
                                    {{ old('feature_id') == $feature->id ? 'selected' : '' }}>{{$feature->name}}
                                </option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-4">
                            ...
                            <div>
                                <input name="old_price" value="{{old('old_price')}}"
                    ...
                    <div class="row mb-4 ">
                        ...
                        <textarea name="specifications" class="product-specs-editor"
                            id="contenteditor">{{old('specifications')}}</textarea>
                    </div>
                    <!--Ảnh-->
                    ...
                    <div class="row col-5 mb-4 ">
                        ...
                        <a id="changeImages" class="text-danger mt-2" style="max-width:200px; display:none"
