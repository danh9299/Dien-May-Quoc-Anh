            ...
            <form method="post" action="{{route('admin.settings.account.update')}}" enctype="multipart/form-data">
                ...
                <div class="row col-5 mb-4 ">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="username" value="{{$account->username}}" class="shadow form-control "  required/>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$account->name}}" class="shadow form-control  @error('name') is-invalid @enderror"  required/>
                        </div>
                        @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="email" name="email" value="{{$account->email}}" class="shadow form-control @error('email') is-invalid @enderror"  required/>
                            @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>
