    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row admin-home-images text-center">
                <div class="col"><a href="{{route('admin.images.long-banners.edit')}}"> <svg
                ...
                <div class="col"><a href="{{route('admin.images.slider-banners.edit')}}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
                ...
                <div class="col"><a href="{{route('admin.images.logo.edit')}}"><svg xmlns="http://www.w3.org/2000/svg"
                            width="45" height="45" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">
