    ...
    <div class="container mt-2 px-5  mb-2">
        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{route('admin.types.create')}}" class="btn btn-primary">Thêm mới</a>
                    </div>
                    <div class="col">
                        <form method="GET" action="{{ route('admin.types.search') }}">
                            <div class="input-group flex-nowrap">
                                <button type="submit" class="btn btn-dark">Tìm kiếm</button>
                                <input type="text" class="form-control" name="search"
                                    placeholder="Nhập tên Phân loại bạn muốn tìm.." aria-label="Tìm kiếm"
            ...
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('admin.types.edit', $type->id)}}" class="btn btn-warning"><svg
                                ...
                                <a href="{{route('admin.types.delete', $type->id)}}" class="btn btn-danger"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    @else
                    <tr>
                        <td colspan="5" class="text-center">Hiện chưa có Phân loại nào được tạo!</td>
                    </tr>
                    @endif
