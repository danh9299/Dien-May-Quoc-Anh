...
<div class="mt-2 mb-2 px-5 container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row mt-5 admin-home-images text-center">
                <div class="col"><a href="{{route('admin.settings.users.list-users')}}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
                ...
                <div class="col"><a href="{{route('admin.settings.reviews.list-reviews')}}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
                ...
                <div class="col"><a href="{{ route('admin.auth.login.logout') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
