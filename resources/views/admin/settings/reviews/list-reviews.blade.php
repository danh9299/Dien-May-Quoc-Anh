            ...
            <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('admin.settings.reviews.delete', $review->id)}}"
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        @for ($i = max(1, $reviews->currentPage() - 3); $i <= min($reviews->lastPage(),
                            $reviews->currentPage() + 3); $i++)
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ $reviews->nextPageUrl() }}" aria-label="Trang tiếp">Sau
                                    &raquo;</a>
                            </li>
                            @else
                            <li class="page-item disabled">
