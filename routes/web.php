...
//Trang main dành cho khách hàng
...
//Chatbot - Hệ thống trả lời tự động
...
Route::group(['middleware' => 'auth.user'], function () {
    ...
    Route::put('/info',[RegisterController::class,'update'])->name('main.auth.update');
...
Route::group(['middleware' => 'check.admin'], function () {
    ...
    Route::put('admin/catalogs/{catalog}/edit', [CatalogController::class, 'update'])->name('admin.catalogs.update');
    ...
    Route::put('admin/brands/{brand}/edit', [BrandController::class, 'update'])->name('admin.brands.update');
    ...
    Route::put('admin/types/{type}/edit', [TypeController::class, 'update'])->name('admin.types.update');
    ...
    Route::put('admin/features/{feature}/edit', [FeatureController::class, 'update'])->name('admin.features.update');
    ...
    Route::put('admin/products/{product}/edit', [ProductController::class, 'update'])->name('admin.products.update');
    Route::get('admin/products/{product}/delete', [ProductController::class, 'delete'])->name('admin.products.delete');
    Route::delete('admin/products/{product}/delete', [ProductController::class, 'destroy'])->name('admin.products.destroy');
    ...
    Route::put('admin/articles/{article}/edit', [ArticleController::class, 'update'])->name('admin.articles.update');
    ...
    Route::put('/admin/images/long-banners/', [ImageController::class, 'updateLongBanners'])->name('admin.images.long-banners.update');
    ...
    Route::post('/admin/orders/{order}/mark-as-undelivered', [CartController::class, 'markAsUnDelivered'])->name('admin.orders.markAsUnDelivered');
    Route::post('/admin/orders/{order}/mark-as-paydone', [CartController::class, 'markAsPayDone'])->name('admin.orders.markAsPayDone');
    Route::post('/admin/orders/{order}/mark-as-paynotdone', [CartController::class, 'markAsPayNotDone'])->name('admin.orders.markAsPayNotDone');
...
Route::group(['middleware' => 'check.admin.role'], function () {
    ...
    Route::put('admin/members/{member}/edit', [MemberController::class, 'update'])->name('admin.members.update');
    Route::get('admin/members/{member}/delete', [MemberController::class, 'delete'])->name('admin.members.delete');
    Route::delete('admin/members/{member}/delete', [MemberController::class, 'destroy'])->name('admin.members.destroy');
    ...
    Route::put('/admin/settings/general/edit', [SettingController::class, 'updateGeneral'])->name('admin.settings.general.update');
    Route::get('/admin/settings/network/edit', [SettingController::class, 'editNetwork'])->name('admin.settings.network.edit');
    Route::put('/admin/settings/network/edit', [SettingController::class, 'updateNetwork'])->name('admin.settings.network.update');
    ...
    Route::delete('admin/settings/{review}/delete', [SettingController::class, 'destroyProductReview'])->name('admin.settings.reviews.destroy');
    //Policy
    ...
    Route::delete('admin/orders/{order}/delete', [CartController::class, 'destroyOrder'])->name('admin.orders.destroy');
