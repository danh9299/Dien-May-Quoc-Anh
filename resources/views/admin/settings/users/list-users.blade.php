...
<div class="row">
    ...
    <ul class="pagination justify-content-center">
        ...
        @else
            <li class="page-item">
                <a class="page-link" href="{{ $users->previousPageUrl() }}" aria-label="Trang trước">&laquo; Trước</a>
            </li>
        @endif
        ...
        @if ($users->hasMorePages())
            <li class="page-item">
                <a class="page-link" href="{{ $users->nextPageUrl() }}" aria-label="Trang tiếp">Sau &raquo;</a>
            </li>
        @else
            <li class="page-item disabled">
