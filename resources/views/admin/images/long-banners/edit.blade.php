            ...
            <form method="post" action="{{route('admin.images.long-banners.update')}}" enctype="multipart/form-data">
                ...
                <div class="row col-5 mb-4 ">
                    ...
                    <input type="text" id="image_link_check_banner1" style="display:none"
                        name="image_link_check_banner1" value="{{$longBanners->firstWhere('id', 5)->image_link}}">
                    <img id="previewImage_banner1"
                        src="{{asset('/img/long-banner/' . $longBanners->firstWhere('id', 5)->image_link) }}"
                    ...
                    <input type="text" id="image_link_check_banner2" style="display:none"
                        name="image_link_check_banner2" value="{{$longBanners->firstWhere('id', 6)->image_link}}">
                    <img id="previewImage_banner2"
                        src="{{asset('/img/long-banner/' . $longBanners->firstWhere('id', 6)->image_link) }}"
                        class="mt-2 img-thumbnail" alt="Preview">
                    ...
                    <input type="text" id="image_link_check_banner3" style="display:none"
                        name="image_link_check_banner3" value="{{$longBanners->firstWhere('id', 7)->image_link}}">
                    <img id="previewImage_banner3"
                        src="{{asset('/img/long-banner/' . $longBanners->firstWhere('id', 7)->image_link) }}"
                        class="mt-2 img-thumbnail" alt="Preview">
                    ...
                    <input type="file" style="display:none" name="image_link_banner4" id="image_link_banner4"
                        onclick="previewImage_banner4()"
                        class="shadow form-control @error('image_link_banner4') is-invalid @enderror" />
                    <input type="text" id="image_link_check_banner4" style="display:none"
                        name="image_link_check_banner4" value="{{$longBanners->firstWhere('id', 8)->image_link}}">
                    <img id="previewImage_banner4"
                        src="{{asset('/img/long-banner/' . $longBanners->firstWhere('id', 8)->image_link) }}"
                        class="mt-2 img-thumbnail" alt="Preview">
